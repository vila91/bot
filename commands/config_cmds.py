...
def register(tree: app_commands.CommandTree) -> None:
    ...
    @tree.command(name="set_rules", description="Modifie les règles du bot (chat + routines)")
    ...
    async def set_rules(interaction: discord.Interaction, text: str) -> None:
        ...
        await interaction.response.send_message("Règles mises à jour.", ephemeral=True)
